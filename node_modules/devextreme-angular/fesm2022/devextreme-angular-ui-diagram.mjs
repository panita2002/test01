...
class DxDiagramComponent extends DxComponent {
    ...
    get customShapesLegacyChildren() {
        return this._getOption('customShapes');
    }
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "17.3.12", ngImport: i0, type: DxDiagramComponent, decorators: [{
            ...
            args: [{
                ...
                args: [DxiDiagramCustomShapeComponent]
            }], customShapesLegacyChildren: [{
                type: ContentChildren,
...
class DxDiagramModule {
    ...
    /** @nocollapse */ static ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "17.3.12", ngImport: i0, type: DxDiagramModule, declarations: [DxDiagramComponent], imports: [DxoContextMenuModule,
            DxiCommandModule,
            DxiItemModule,
            ...
            DxoDiagramZoomLevelModule,
            DxTemplateModule] });
    /** @nocollapse */ static ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "17.3.12", ngImport: i0, type: DxDiagramModule, imports: [DxoContextMenuModule,
            DxiCommandModule,
            DxiItemModule,
            DxoContextToolboxModule,
            DxiCustomShapeModule,

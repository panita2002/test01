...
import { DxiSelectBoxButtonComponent, DxiSelectBoxItemComponent, DxoSelectBoxAnimationModule, DxoSelectBoxAtModule, DxoSelectBoxBoundaryOffsetModule, DxiSelectBoxButtonModule, DxoSelectBoxCollisionModule, DxoSelectBoxDropDownOptionsModule, DxoSelectBoxFromModule, DxoSelectBoxHideModule, DxiSelectBoxItemModule, DxoSelectBoxMyModule, DxoSelectBoxOffsetModule, DxoSelectBoxOptionsModule, DxoSelectBoxPositionModule, DxoSelectBoxShowModule, DxoSelectBoxToModule, DxiSelectBoxToolbarItemModule } from 'devextreme-angular/ui/select-box/nested';
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "17.3.12", ngImport: i0, type: DxSelectBoxComponent, decorators: [{
            ...
            args: [{
                ...
                args: [DxiSelectBoxButtonComponent]
            }], itemsChildren: [{
                type: ContentChildren,
                args: [DxiSelectBoxItemComponent]
...
class DxSelectBoxModule {
    ...
    /** @nocollapse */ static ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "17.3.12", ngImport: i0, type: DxSelectBoxModule, declarations: [DxSelectBoxComponent], imports: [DxiButtonModule,
            DxoOptionsModule,
            ...
            DxiSelectBoxToolbarItemModule,
            DxTemplateModule] });
    /** @nocollapse */ static ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "17.3.12", ngImport: i0, type: DxSelectBoxModule, imports: [DxiButtonModule,
            DxoOptionsModule,
            DxoDropDownOptionsModule,
            DxoAnimationModule,
            DxoHideModule,

...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "17.3.12", ngImport: i0, type: DxTagBoxComponent, decorators: [{
            ...
            args: [{
                ...
                args: [DxiTagBoxButtonComponent]
            }], itemsChildren: [{
                type: ContentChildren,
                args: [DxiTagBoxItemComponent]
...
class DxTagBoxModule {
    ...
    /** @nocollapse */ static ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "17.3.12", ngImport: i0, type: DxTagBoxModule, declarations: [DxTagBoxComponent], imports: [DxiButtonModule,
            DxoOptionsModule,
            ...
            DxiTagBoxToolbarItemModule,
            DxTemplateModule] });
    /** @nocollapse */ static ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "17.3.12", ngImport: i0, type: DxTagBoxModule, imports: [DxiButtonModule,
            DxoOptionsModule,
            DxoDropDownOptionsModule,
            DxoAnimationModule,
            DxoHideModule,

...
import { DxiResponsiveBoxColComponent, DxiResponsiveBoxItemComponent, DxiResponsiveBoxRowComponent, DxiResponsiveBoxColModule, DxiResponsiveBoxItemModule, DxiResponsiveBoxLocationModule, DxiResponsiveBoxRowModule } from 'devextreme-angular/ui/responsive-box/nested';
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "17.3.12", ngImport: i0, type: DxResponsiveBoxComponent, decorators: [{
            ...
            args: [{
                ...
                args: [DxiResponsiveBoxColComponent]
            }], itemsChildren: [{
                type: ContentChildren,
                args: [DxiResponsiveBoxItemComponent]
            }], rowsChildren: [{
                type: ContentChildren,
                args: [DxiResponsiveBoxRowComponent]
            }], colsLegacyChildren: [{
                type: ContentChildren,
...
class DxResponsiveBoxModule {
    ...
    /** @nocollapse */ static ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "17.3.12", ngImport: i0, type: DxResponsiveBoxModule, declarations: [DxResponsiveBoxComponent], imports: [DxiColModule,
            DxiItemModule,
            DxiLocationModule,
            DxiRowModule,
            ...
            DxiResponsiveBoxRowModule,
            DxTemplateModule] });
    /** @nocollapse */ static ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "17.3.12", ngImport: i0, type: DxResponsiveBoxModule, imports: [DxiColModule,
            DxiItemModule,
            DxiLocationModule,
            DxiRowModule,
            DxiResponsiveBoxColModule,

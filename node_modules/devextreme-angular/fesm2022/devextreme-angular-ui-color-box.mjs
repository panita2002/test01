...
import { DxiButtonComponent, DxiButtonModule, DxoOptionsModule, DxoDropDownOptionsModule, DxoAnimationModule, DxoHideModule, DxoFromModule, DxoPositionModule, DxoAtModule, DxoBoundaryOffsetModule, DxoCollisionModule, DxoMyModule, DxoOffsetModule, DxoToModule, DxoShowModule } from 'devextreme-angular/ui/nested';
import { DxiColorBoxButtonComponent, DxoColorBoxAnimationModule, DxoColorBoxAtModule, DxoColorBoxBoundaryOffsetModule, DxiColorBoxButtonModule, DxoColorBoxCollisionModule, DxoColorBoxDropDownOptionsModule, DxoColorBoxFromModule, DxoColorBoxHideModule, DxoColorBoxMyModule, DxoColorBoxOffsetModule, DxoColorBoxOptionsModule, DxoColorBoxPositionModule, DxoColorBoxShowModule, DxoColorBoxToModule, DxiColorBoxToolbarItemModule } from 'devextreme-angular/ui/color-box/nested';
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "17.3.12", ngImport: i0, type: DxColorBoxComponent, decorators: [{
            ...
            args: [{
                ...
                args: [DxiColorBoxButtonComponent]
...
class DxColorBoxModule {
    ...
    /** @nocollapse */ static ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "17.3.12", ngImport: i0, type: DxColorBoxModule, declarations: [DxColorBoxComponent], imports: [DxiButtonModule,
            DxoOptionsModule,
            ...
            DxiColorBoxToolbarItemModule,
            DxTemplateModule] });
    /** @nocollapse */ static ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "17.3.12", ngImport: i0, type: DxColorBoxModule, imports: [DxiButtonModule,
            DxoOptionsModule,
            DxoDropDownOptionsModule,
            DxoAnimationModule,
            DxoHideModule,

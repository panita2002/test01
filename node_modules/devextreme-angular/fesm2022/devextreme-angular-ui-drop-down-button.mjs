...
import { DxiItemComponent, DxoDropDownOptionsModule, DxoAnimationModule, DxoHideModule, DxoFromModule, DxoPositionModule, DxoAtModule, DxoBoundaryOffsetModule, DxoCollisionModule, DxoMyModule, DxoOffsetModule, DxoToModule, DxoShowModule, DxiItemModule } from 'devextreme-angular/ui/nested';
import { DxiDropDownButtonItemComponent, DxoDropDownButtonAnimationModule, DxoDropDownButtonAtModule, DxoDropDownButtonBoundaryOffsetModule, DxoDropDownButtonCollisionModule, DxoDropDownButtonDropDownOptionsModule, DxoDropDownButtonFromModule, DxoDropDownButtonHideModule, DxiDropDownButtonItemModule, DxoDropDownButtonMyModule, DxoDropDownButtonOffsetModule, DxoDropDownButtonPositionModule, DxoDropDownButtonShowModule, DxoDropDownButtonToModule, DxiDropDownButtonToolbarItemModule } from 'devextreme-angular/ui/drop-down-button/nested';
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "17.3.12", ngImport: i0, type: DxDropDownButtonComponent, decorators: [{
            ...
            args: [{
                ...
                args: [DxiDropDownButtonItemComponent]
            }], itemsLegacyChildren: [{
                type: ContentChildren,
...
class DxDropDownButtonModule {
    ...
    /** @nocollapse */ static ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "17.3.12", ngImport: i0, type: DxDropDownButtonModule, declarations: [DxDropDownButtonComponent], imports: [DxoDropDownOptionsModule,
            DxoAnimationModule,
            DxoHideModule,
            DxoFromModule,
            DxoPositionModule,
            ...
            DxiDropDownButtonToolbarItemModule,
            DxTemplateModule] });
    /** @nocollapse */ static ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "17.3.12", ngImport: i0, type: DxDropDownButtonModule, imports: [DxoDropDownOptionsModule,
            DxoAnimationModule,
            DxoHideModule,
            DxoFromModule,
            DxoPositionModule,

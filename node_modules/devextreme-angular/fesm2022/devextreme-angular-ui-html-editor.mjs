...
import { DxiMentionComponent, DxoConverterModule, DxoImageUploadModule, DxoFileUploaderOptionsModule, DxiTabModule, DxoMediaResizingModule, DxiMentionModule, DxoTableContextMenuModule, DxiItemModule, DxoTableResizingModule, DxoToolbarModule, DxoVariablesModule } from 'devextreme-angular/ui/nested';
import { DxiHtmlEditorMentionComponent, DxoHtmlEditorConverterModule, DxoHtmlEditorFileUploaderOptionsModule, DxoHtmlEditorImageUploadModule, DxiHtmlEditorItemModule, DxoHtmlEditorMediaResizingModule, DxiHtmlEditorMentionModule, DxiHtmlEditorTabModule, DxoHtmlEditorTableContextMenuModule, DxiHtmlEditorTableContextMenuItemModule, DxoHtmlEditorTableResizingModule, DxoHtmlEditorToolbarModule, DxiHtmlEditorToolbarItemModule, DxoHtmlEditorVariablesModule } from 'devextreme-angular/ui/html-editor/nested';
...
/**
 * HtmlEditor is a WYSIWYG editor that allows you to format textual and visual content and to output it in HTML. HtmlEditor is built on top of and requires the DevExtreme Quill.
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "17.3.12", ngImport: i0, type: DxHtmlEditorComponent, decorators: [{
            ...
            args: [{
                ...
                args: [DxiHtmlEditorMentionComponent]
            }], mentionsLegacyChildren: [{
                type: ContentChildren,
...
class DxHtmlEditorModule {
    ...
    /** @nocollapse */ static ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "17.3.12", ngImport: i0, type: DxHtmlEditorModule, declarations: [DxHtmlEditorComponent], imports: [DxoConverterModule,
            ...
            DxoHtmlEditorVariablesModule,
            DxTemplateModule] });
    /** @nocollapse */ static ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "17.3.12", ngImport: i0, type: DxHtmlEditorModule, imports: [DxoConverterModule,
            DxoImageUploadModule,
            DxoFileUploaderOptionsModule,
            DxiTabModule,
            DxoMediaResizingModule,

...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "17.3.12", ngImport: i0, type: DxAutocompleteComponent, decorators: [{
            ...
            args: [{
                ...
                args: [DxiAutocompleteButtonComponent]
            }], itemsChildren: [{
                type: ContentChildren,
                args: [DxiAutocompleteItemComponent]
...
class DxAutocompleteModule {
    ...
    /** @nocollapse */ static ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "17.3.12", ngImport: i0, type: DxAutocompleteModule, declarations: [DxAutocompleteComponent], imports: [DxiButtonModule,
            DxoOptionsModule,
            ...
            DxiAutocompleteToolbarItemModule,
            DxTemplateModule] });
    /** @nocollapse */ static ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "17.3.12", ngImport: i0, type: DxAutocompleteModule, imports: [DxiButtonModule,
            DxoOptionsModule,
            DxoDropDownOptionsModule,
            DxoAnimationModule,
            DxoHideModule,

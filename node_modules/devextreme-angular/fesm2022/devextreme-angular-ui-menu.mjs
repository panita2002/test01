...
import { DxiMenuItemComponent, DxoMenuAnimationModule, DxoMenuAtModule, DxoMenuBoundaryOffsetModule, DxoMenuCollisionModule, DxoMenuDelayModule, DxoMenuFromModule, DxoMenuHideModule, DxiMenuItemModule, DxoMenuMyModule, DxoMenuOffsetModule, DxoMenuPositionModule, DxoMenuShowModule, DxoMenuShowFirstSubmenuModeModule, DxoMenuShowSubmenuModeModule, DxoMenuToModule } from 'devextreme-angular/ui/menu/nested';
...
class DxMenuModule {
    ...
    /** @nocollapse */ static ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "17.3.12", ngImport: i0, type: DxMenuModule, declarations: [DxMenuComponent], imports: [DxoAnimationModule,
            DxoHideModule,
            DxoFromModule,
            DxoPositionModule,
            DxoAtModule,
            ...
            DxoMenuToModule,
            DxTemplateModule] });
    /** @nocollapse */ static ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "17.3.12", ngImport: i0, type: DxMenuModule, imports: [DxoAnimationModule,
            DxoHideModule,
            DxoFromModule,
            DxoPositionModule,
            DxoAtModule,

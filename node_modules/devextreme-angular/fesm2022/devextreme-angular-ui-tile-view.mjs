...
import { DxiTileViewItemComponent, DxiTileViewItemModule } from 'devextreme-angular/ui/tile-view/nested';
...
class DxTileViewModule {
    ...
    /** @nocollapse */ static ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "17.3.12", ngImport: i0, type: DxTileViewModule, declarations: [DxTileViewComponent], imports: [DxiItemModule,
            DxiTileViewItemModule,
            DxIntegrationModule,
            DxTemplateModule], exports: [DxTileViewComponent, DxiItemModule,
            DxiTileViewItemModule,
            DxTemplateModule] });
    /** @nocollapse */ static ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "17.3.12", ngImport: i0, type: DxTileViewModule, imports: [DxiItemModule,
            DxiTileViewItemModule,
            DxIntegrationModule,

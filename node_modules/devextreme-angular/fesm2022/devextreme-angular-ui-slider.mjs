...
class DxSliderModule {
    ...
    /** @nocollapse */ static ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "17.3.12", ngImport: i0, type: DxSliderModule, declarations: [DxSliderComponent], imports: [DxoLabelModule,
            DxoFormatModule,
            DxoTooltipModule,
            ...
            DxoSliderTooltipModule,
            DxTemplateModule] });
    /** @nocollapse */ static ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "17.3.12", ngImport: i0, type: DxSliderModule, imports: [DxoLabelModule,
            DxoFormatModule,
            DxoTooltipModule,
            DxoSliderFormatModule,
            DxoSliderLabelModule,

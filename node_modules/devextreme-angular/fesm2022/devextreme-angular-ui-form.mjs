...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "17.3.12", ngImport: i0, type: DxFormComponent, decorators: [{
            ...
            args: [{
                ...
                args: [DxiFormButtonItemComponent]
            }], emptyItemsChildren: [{
                type: ContentChildren,
                args: [DxiFormEmptyItemComponent]
            }], groupItemsChildren: [{
                type: ContentChildren,
                args: [DxiFormGroupItemComponent]
            }], itemsChildren: [{
                type: ContentChildren,
                args: [DxiFormItemComponent]
            }], simpleItemsChildren: [{
                type: ContentChildren,
                args: [DxiFormSimpleItemComponent]
            }], tabbedItemsChildren: [{
                type: ContentChildren,
                args: [DxiFormTabbedItemComponent]
            }], itemsLegacyChildren: [{
                type: ContentChildren,
...
class DxFormModule {
    ...
    /** @nocollapse */ static ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "17.3.12", ngImport: i0, type: DxFormModule, declarations: [DxFormComponent], imports: [DxoColCountByScreenModule,
            DxiItemModule,
            DxoLabelModule,
            ...
            DxiFormValidationRuleModule,
            DxTemplateModule] });
    /** @nocollapse */ static ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "17.3.12", ngImport: i0, type: DxFormModule, imports: [DxoColCountByScreenModule,
            DxiItemModule,
            DxoLabelModule,
            DxiValidationRuleModule,
            DxoTabPanelOptionsModule,

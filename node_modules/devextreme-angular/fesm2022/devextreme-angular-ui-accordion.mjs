...
import { DxiAccordionItemComponent, DxiAccordionItemModule } from 'devextreme-angular/ui/accordion/nested';
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "17.3.12", ngImport: i0, type: DxAccordionComponent, decorators: [{
            ...
            args: [{
                ...
                args: [DxiAccordionItemComponent]
            }], itemsLegacyChildren: [{
                type: ContentChildren,
...
class DxAccordionModule {
    ...
    /** @nocollapse */ static ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "17.3.12", ngImport: i0, type: DxAccordionModule, declarations: [DxAccordionComponent], imports: [DxiItemModule,
            DxiAccordionItemModule,
            DxIntegrationModule,
            DxTemplateModule], exports: [DxAccordionComponent, DxiItemModule,
            DxiAccordionItemModule,
            DxTemplateModule] });
    /** @nocollapse */ static ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "17.3.12", ngImport: i0, type: DxAccordionModule, imports: [DxiItemModule,
            DxiAccordionItemModule,
            DxIntegrationModule,

...
import { DxiDropDownBoxButtonComponent, DxoDropDownBoxAnimationModule, DxoDropDownBoxAtModule, DxoDropDownBoxBoundaryOffsetModule, DxiDropDownBoxButtonModule, DxoDropDownBoxCollisionModule, DxoDropDownBoxDropDownOptionsModule, DxoDropDownBoxFromModule, DxoDropDownBoxHideModule, DxoDropDownBoxMyModule, DxoDropDownBoxOffsetModule, DxoDropDownBoxOptionsModule, DxoDropDownBoxPositionModule, DxoDropDownBoxShowModule, DxoDropDownBoxToModule, DxiDropDownBoxToolbarItemModule } from 'devextreme-angular/ui/drop-down-box/nested';
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "17.3.12", ngImport: i0, type: DxDropDownBoxComponent, decorators: [{
            ...
            args: [{
                ...
                args: [DxiDropDownBoxButtonComponent]
...
class DxDropDownBoxModule {
    ...
    /** @nocollapse */ static ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "17.3.12", ngImport: i0, type: DxDropDownBoxModule, declarations: [DxDropDownBoxComponent], imports: [DxiButtonModule,
            DxoOptionsModule,
            ...
            DxiDropDownBoxToolbarItemModule,
            DxTemplateModule] });
    /** @nocollapse */ static ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "17.3.12", ngImport: i0, type: DxDropDownBoxModule, imports: [DxiButtonModule,
            DxoOptionsModule,
            DxoDropDownOptionsModule,
            DxoAnimationModule,
            DxoHideModule,

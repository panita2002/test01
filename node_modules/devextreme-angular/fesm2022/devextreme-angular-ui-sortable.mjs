...
class DxSortableModule {
    ...
    /** @nocollapse */ static ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "17.3.12", ngImport: i0, type: DxSortableModule, declarations: [DxSortableComponent], imports: [DxoCursorOffsetModule,
            DxoSortableCursorOffsetModule,
            DxIntegrationModule,
            DxTemplateModule], exports: [DxSortableComponent, DxoCursorOffsetModule,
            DxoSortableCursorOffsetModule,
            DxTemplateModule] });
    /** @nocollapse */ static ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "17.3.12", ngImport: i0, type: DxSortableModule, imports: [DxoCursorOffsetModule,
            DxoSortableCursorOffsetModule,
            DxIntegrationModule,

...
import { DxiTabsItemComponent, DxiTabsItemModule } from 'devextreme-angular/ui/tabs/nested';
...
class DxTabsModule {
    ...
    /** @nocollapse */ static ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "17.3.12", ngImport: i0, type: DxTabsModule, declarations: [DxTabsComponent], imports: [DxiItemModule,
            DxiTabsItemModule,
            DxIntegrationModule,
            DxTemplateModule], exports: [DxTabsComponent, DxiItemModule,
            DxiTabsItemModule,
            DxTemplateModule] });
    /** @nocollapse */ static ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "17.3.12", ngImport: i0, type: DxTabsModule, imports: [DxiItemModule,
            DxiTabsItemModule,
            DxIntegrationModule,

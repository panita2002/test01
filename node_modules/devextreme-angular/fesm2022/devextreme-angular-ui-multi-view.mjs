...
import { DxiMultiViewItemComponent, DxiMultiViewItemModule } from 'devextreme-angular/ui/multi-view/nested';
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "17.3.12", ngImport: i0, type: DxMultiViewComponent, decorators: [{
            ...
            args: [{
                ...
                args: [DxiMultiViewItemComponent]
            }], itemsLegacyChildren: [{
                type: ContentChildren,
...
class DxMultiViewModule {
    ...
    /** @nocollapse */ static ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "17.3.12", ngImport: i0, type: DxMultiViewModule, declarations: [DxMultiViewComponent], imports: [DxiItemModule,
            DxiMultiViewItemModule,
            DxIntegrationModule,
            DxTemplateModule], exports: [DxMultiViewComponent, DxiItemModule,
            DxiMultiViewItemModule,
            DxTemplateModule] });
    /** @nocollapse */ static ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "17.3.12", ngImport: i0, type: DxMultiViewModule, imports: [DxiItemModule,
            DxiMultiViewItemModule,
            DxIntegrationModule,

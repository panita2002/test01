...
import { DxiFilterBuilderCustomOperationComponent, DxiFilterBuilderFieldComponent, DxiFilterBuilderCustomOperationModule, DxiFilterBuilderFieldModule, DxoFilterBuilderFilterOperationDescriptionsModule, DxoFilterBuilderFormatModule, DxoFilterBuilderGroupOperationDescriptionsModule, DxoFilterBuilderLookupModule } from 'devextreme-angular/ui/filter-builder/nested';
...
class DxFilterBuilderComponent extends DxComponent {
    ...
    get customOperationsLegacyChildren() {
        return this._getOption('customOperations');
    }
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "17.3.12", ngImport: i0, type: DxFilterBuilderComponent, decorators: [{
            ...
            args: [{
                ...
                args: [DxiFilterBuilderCustomOperationComponent]
            }], fieldsChildren: [{
                type: ContentChildren,
                args: [DxiFilterBuilderFieldComponent]
            }], customOperationsLegacyChildren: [{
                type: ContentChildren,
                args: [DxiCustomOperationComponent]
            }], fieldsLegacyChildren: [{
                type: ContentChildren,
...
class DxFilterBuilderModule {
    ...
    /** @nocollapse */ static ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "17.3.12", ngImport: i0, type: DxFilterBuilderModule, declarations: [DxFilterBuilderComponent], imports: [DxiCustomOperationModule,
            DxiFieldModule,
            DxoFormatModule,
            DxoLookupModule,
            ...
            DxoFilterBuilderLookupModule,
            DxTemplateModule] });
    /** @nocollapse */ static ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "17.3.12", ngImport: i0, type: DxFilterBuilderModule, imports: [DxiCustomOperationModule,
            DxiFieldModule,
            DxoFormatModule,
            DxoLookupModule,
            DxoFilterOperationDescriptionsModule,

...
import { DxiButtonGroupItemComponent, DxiButtonGroupItemModule } from 'devextreme-angular/ui/button-group/nested';
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "17.3.12", ngImport: i0, type: DxButtonGroupComponent, decorators: [{
            ...
            args: [{
                ...
                args: [DxiButtonGroupItemComponent]
            }], itemsLegacyChildren: [{
                type: ContentChildren,
...
class DxButtonGroupModule {
    ...
    /** @nocollapse */ static ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "17.3.12", ngImport: i0, type: DxButtonGroupModule, declarations: [DxButtonGroupComponent], imports: [DxiItemModule,
            DxiButtonGroupItemModule,
            DxIntegrationModule,
            DxTemplateModule], exports: [DxButtonGroupComponent, DxiItemModule,
            DxiButtonGroupItemModule,
            DxTemplateModule] });
    /** @nocollapse */ static ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "17.3.12", ngImport: i0, type: DxButtonGroupModule, imports: [DxiItemModule,
            DxiButtonGroupItemModule,
            DxIntegrationModule,

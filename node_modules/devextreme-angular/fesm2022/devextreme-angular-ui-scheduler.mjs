...
import { DxiSchedulerResourceComponent, DxiSchedulerViewComponent, DxoSchedulerAppointmentDraggingModule, DxoSchedulerEditingModule, DxiSchedulerResourceModule, DxoSchedulerScrollingModule, DxiSchedulerViewModule } from 'devextreme-angular/ui/scheduler/nested';
...
class DxSchedulerModule {
    ...
    /** @nocollapse */ static ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "17.3.12", ngImport: i0, type: DxSchedulerModule, declarations: [DxSchedulerComponent], imports: [DxoAppointmentDraggingModule,
            DxoEditingModule,
            DxiResourceModule,
            DxoScrollingModule,
            DxiViewModule,
            ...
            DxiSchedulerViewModule,
            DxTemplateModule] });
    /** @nocollapse */ static ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "17.3.12", ngImport: i0, type: DxSchedulerModule, imports: [DxoAppointmentDraggingModule,
            DxoEditingModule,
            DxiResourceModule,
            DxoScrollingModule,
            DxiViewModule,

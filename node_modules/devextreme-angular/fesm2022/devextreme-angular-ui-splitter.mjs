...
import { DxiItemComponent, DxiItemModule, DxoSplitterModule } from 'devextreme-angular/ui/nested';
import { DxiSplitterItemComponent, DxiSplitterItemModule } from 'devextreme-angular/ui/splitter/nested';
...
class DxSplitterModule {
    ...
    /** @nocollapse */ static ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "17.3.12", ngImport: i0, type: DxSplitterModule, declarations: [DxSplitterComponent], imports: [DxiItemModule,
            DxoSplitterModule,
            ...
            DxiSplitterItemModule,
            DxTemplateModule] });
    /** @nocollapse */ static ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "17.3.12", ngImport: i0, type: DxSplitterModule, imports: [DxiItemModule,
            DxoSplitterModule,
            DxiSplitterItemModule,
            DxIntegrationModule,

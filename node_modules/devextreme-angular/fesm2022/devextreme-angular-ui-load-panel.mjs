...
import { DxoLoadPanelAnimationModule, DxoLoadPanelAtModule, DxoLoadPanelBoundaryOffsetModule, DxoLoadPanelCollisionModule, DxoLoadPanelFromModule, DxoLoadPanelHideModule, DxoLoadPanelMyModule, DxoLoadPanelOffsetModule, DxoLoadPanelPositionModule, DxoLoadPanelShowModule, DxoLoadPanelToModule } from 'devextreme-angular/ui/load-panel/nested';
...
class DxLoadPanelModule {
    ...
    /** @nocollapse */ static ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "17.3.12", ngImport: i0, type: DxLoadPanelModule, declarations: [DxLoadPanelComponent], imports: [DxoAnimationModule,
            DxoHideModule,
            DxoFromModule,
            DxoPositionModule,
            DxoAtModule,
            ...
            DxoLoadPanelToModule,
            DxTemplateModule] });
    /** @nocollapse */ static ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "17.3.12", ngImport: i0, type: DxLoadPanelModule, imports: [DxoAnimationModule,
            DxoHideModule,
            DxoFromModule,
            DxoPositionModule,
            DxoAtModule,

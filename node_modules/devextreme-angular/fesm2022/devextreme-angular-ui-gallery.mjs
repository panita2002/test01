...
import { DxiGalleryItemComponent, DxiGalleryItemModule } from 'devextreme-angular/ui/gallery/nested';
...
class DxGalleryModule {
    ...
    /** @nocollapse */ static ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "17.3.12", ngImport: i0, type: DxGalleryModule, declarations: [DxGalleryComponent], imports: [DxiItemModule,
            DxiGalleryItemModule,
            DxIntegrationModule,
            DxTemplateModule], exports: [DxGalleryComponent, DxiItemModule,
            DxiGalleryItemModule,
            DxTemplateModule] });
    /** @nocollapse */ static ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "17.3.12", ngImport: i0, type: DxGalleryModule, imports: [DxiItemModule,
            DxiGalleryItemModule,
            DxIntegrationModule,

...
import { DxiCenterComponent, DxiMarkerComponent, DxiRouteComponent, DxoApiKeyModule, DxiCenterModule, DxiMarkerModule, DxiLocationModule, DxoTooltipModule, DxoProviderConfigModule, DxiRouteModule } from 'devextreme-angular/ui/nested';
import { DxiMapMarkerComponent, DxiMapRouteComponent, DxoMapApiKeyModule, DxoMapCenterModule, DxoMapLocationModule, DxiMapMarkerModule, DxoMapProviderConfigModule, DxiMapRouteModule, DxoMapTooltipModule, DxiMapLocationModule } from 'devextreme-angular/ui/map/nested';
...
class DxMapModule {
    ...
    /** @nocollapse */ static ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "17.3.12", ngImport: i0, type: DxMapModule, declarations: [DxMapComponent], imports: [DxoApiKeyModule,
            DxiCenterModule,
            DxiMarkerModule,
            DxiLocationModule,
            DxoTooltipModule,
            ...
            DxiMapLocationModule,
            DxTemplateModule] });
    /** @nocollapse */ static ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "17.3.12", ngImport: i0, type: DxMapModule, imports: [DxoApiKeyModule,
            DxiCenterModule,
            DxiMarkerModule,
            DxiLocationModule,
            DxoTooltipModule,

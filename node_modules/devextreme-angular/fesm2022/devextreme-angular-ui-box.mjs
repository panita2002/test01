...
import { DxiBoxItemComponent, DxiBoxItemModule } from 'devextreme-angular/ui/box/nested';
...
class DxBoxModule {
    ...
    /** @nocollapse */ static ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "17.3.12", ngImport: i0, type: DxBoxModule, declarations: [DxBoxComponent], imports: [DxiItemModule,
            DxoBoxModule,
            DxiBoxItemModule,
            DxIntegrationModule,
            ...
            DxiBoxItemModule,
            DxTemplateModule] });
    /** @nocollapse */ static ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "17.3.12", ngImport: i0, type: DxBoxModule, imports: [DxiItemModule,
            DxoBoxModule,
            DxiBoxItemModule,
            DxIntegrationModule,

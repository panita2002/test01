...
import { DxiTabPanelItemComponent, DxiTabPanelItemModule } from 'devextreme-angular/ui/tab-panel/nested';
...
class DxTabPanelModule {
    ...
    /** @nocollapse */ static ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "17.3.12", ngImport: i0, type: DxTabPanelModule, declarations: [DxTabPanelComponent], imports: [DxiItemModule,
            DxiTabPanelItemModule,
            DxIntegrationModule,
            DxTemplateModule], exports: [DxTabPanelComponent, DxiItemModule,
            DxiTabPanelItemModule,
            DxTemplateModule] });
    /** @nocollapse */ static ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "17.3.12", ngImport: i0, type: DxTabPanelModule, imports: [DxiItemModule,
            DxiTabPanelItemModule,
            DxIntegrationModule,

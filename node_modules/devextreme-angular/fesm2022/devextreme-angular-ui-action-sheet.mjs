...
import { DxiActionSheetItemComponent, DxiActionSheetItemModule } from 'devextreme-angular/ui/action-sheet/nested';
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "17.3.12", ngImport: i0, type: DxActionSheetComponent, decorators: [{
            ...
            args: [{
                ...
                args: [DxiActionSheetItemComponent]
            }], itemsLegacyChildren: [{
                type: ContentChildren,
...
class DxActionSheetModule {
    ...
    /** @nocollapse */ static ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "17.3.12", ngImport: i0, type: DxActionSheetModule, declarations: [DxActionSheetComponent], imports: [DxiItemModule,
            DxiActionSheetItemModule,
            DxIntegrationModule,
            DxTemplateModule], exports: [DxActionSheetComponent, DxiItemModule,
            DxiActionSheetItemModule,
            DxTemplateModule] });
    /** @nocollapse */ static ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "17.3.12", ngImport: i0, type: DxActionSheetModule, imports: [DxiItemModule,
            DxiActionSheetItemModule,
            DxIntegrationModule,

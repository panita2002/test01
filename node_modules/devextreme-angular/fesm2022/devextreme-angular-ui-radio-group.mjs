...
import { DxiRadioGroupItemComponent, DxiRadioGroupItemModule } from 'devextreme-angular/ui/radio-group/nested';
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "17.3.12", ngImport: i0, type: DxRadioGroupComponent, decorators: [{
            ...
            args: [{
                ...
                args: [DxiRadioGroupItemComponent]
            }], itemsLegacyChildren: [{
                type: ContentChildren,
...
class DxRadioGroupModule {
    ...
    /** @nocollapse */ static ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "17.3.12", ngImport: i0, type: DxRadioGroupModule, declarations: [DxRadioGroupComponent], imports: [DxiItemModule,
            DxiRadioGroupItemModule,
            DxIntegrationModule,
            DxTemplateModule], exports: [DxRadioGroupComponent, DxiItemModule,
            DxiRadioGroupItemModule,
            DxTemplateModule] });
    /** @nocollapse */ static ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "17.3.12", ngImport: i0, type: DxRadioGroupModule, imports: [DxiItemModule,
            DxiRadioGroupItemModule,
            DxIntegrationModule,

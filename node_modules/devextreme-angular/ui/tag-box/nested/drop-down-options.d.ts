...
export declare class DxoTagBoxDropDownOptionsComponent extends NestedOption implements OnDestroy, OnInit {
    ...
    set toolbarItemsChildren(value: QueryList<DxiTagBoxToolbarItemComponent>);
...
export declare class DxoTagBoxDropDownOptionsModule {
    ...
    static ɵmod: i0.ɵɵNgModuleDeclaration<DxoTagBoxDropDownOptionsModule, [typeof DxoTagBoxDropDownOptionsComponent], never, [typeof DxoTagBoxDropDownOptionsComponent]>;

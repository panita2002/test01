...
export declare class DxiBoxItemComponent extends CollectionNestedOption implements AfterViewInit, IDxTemplateHost {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<DxiBoxItemComponent, "dxi-box-item", never, { "baseSize": { "alias": "baseSize"; "required": false; }; "box": { "alias": "box"; "required": false; }; "disabled": { "alias": "disabled"; "required": false; }; "html": { "alias": "html"; "required": false; }; "ratio": { "alias": "ratio"; "required": false; }; "shrink": { "alias": "shrink"; "required": false; }; "template": { "alias": "template"; "required": false; }; "text": { "alias": "text"; "required": false; }; "visible": { "alias": "visible"; "required": false; }; }, {}, never, ["*"], false, never>;
}
export declare class DxiBoxItemModule {
    static ɵfac: i0.ɵɵFactoryDeclaration<DxiBoxItemModule, never>;
    static ɵmod: i0.ɵɵNgModuleDeclaration<DxiBoxItemModule, [typeof DxiBoxItemComponent], never, [typeof DxiBoxItemComponent]>;

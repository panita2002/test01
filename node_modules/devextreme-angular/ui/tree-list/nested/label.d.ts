...
export declare class DxoTreeListLabelComponent extends NestedOption implements AfterViewInit, OnDestroy, OnInit, IDxTemplateHost {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<DxoTreeListLabelComponent, "dxo-tree-list-label", never, { "alignment": { "alias": "alignment"; "required": false; }; "location": { "alias": "location"; "required": false; }; "showColon": { "alias": "showColon"; "required": false; }; "template": { "alias": "template"; "required": false; }; "text": { "alias": "text"; "required": false; }; "visible": { "alias": "visible"; "required": false; }; }, {}, never, ["*"], false, never>;
}
export declare class DxoTreeListLabelModule {
    static ɵfac: i0.ɵɵFactoryDeclaration<DxoTreeListLabelModule, never>;
    static ɵmod: i0.ɵɵNgModuleDeclaration<DxoTreeListLabelModule, [typeof DxoTreeListLabelComponent], never, [typeof DxoTreeListLabelComponent]>;

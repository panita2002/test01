...
export declare class DxoTreeListPopupComponent extends NestedOption implements OnDestroy, OnInit {
    ...
    set toolbarItemsChildren(value: QueryList<DxiTreeListToolbarItemComponent>);
...
export declare class DxoTreeListPopupModule {
    ...
    static ɵmod: i0.ɵɵNgModuleDeclaration<DxoTreeListPopupModule, [typeof DxoTreeListPopupComponent], never, [typeof DxoTreeListPopupComponent]>;

...
export declare class DxGalleryComponent<TItem = any, TKey = any> extends DxComponent implements OnDestroy, OnChanges, DoCheck {
    ...
    set itemsChildren(value: QueryList<DxiGalleryItemComponent>);

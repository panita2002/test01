...
export declare class DxSchedulerComponent extends DxComponent implements OnDestroy, OnChanges, DoCheck {
    ...
    set resourcesChildren(value: QueryList<DxiSchedulerResourceComponent>);
    get viewsChildren(): QueryList<DxiSchedulerViewComponent>;
    set viewsChildren(value: QueryList<DxiSchedulerViewComponent>);
    get resourcesLegacyChildren(): QueryList<DxiResourceComponent>;
    set resourcesLegacyChildren(value: QueryList<DxiResourceComponent>);
    get viewsLegacyChildren(): QueryList<DxiViewComponent>;
    set viewsLegacyChildren(value: QueryList<DxiViewComponent>);

...
export declare class DxoColorBoxDropDownOptionsComponent extends NestedOption implements OnDestroy, OnInit {
    ...
    set toolbarItemsChildren(value: QueryList<DxiColorBoxToolbarItemComponent>);
...
export declare class DxoColorBoxDropDownOptionsModule {
    ...
    static ɵmod: i0.ɵɵNgModuleDeclaration<DxoColorBoxDropDownOptionsModule, [typeof DxoColorBoxDropDownOptionsComponent], never, [typeof DxoColorBoxDropDownOptionsComponent]>;

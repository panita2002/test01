...
export declare class DxGanttComponent extends DxComponent implements OnDestroy, OnChanges, DoCheck {
    ...
    set columnsChildren(value: QueryList<DxiGanttColumnComponent>);
    ...
    set stripLinesLegacyChildren(value: QueryList<DxiStripLineComponent>);

...
export declare class DxiGanttStripLineComponent extends CollectionNestedOption {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<DxiGanttStripLineComponent, "dxi-gantt-strip-line", never, { "cssClass": { "alias": "cssClass"; "required": false; }; "end": { "alias": "end"; "required": false; }; "start": { "alias": "start"; "required": false; }; "title": { "alias": "title"; "required": false; }; }, {}, never, never, false, never>;
}
export declare class DxiGanttStripLineModule {
    static ɵfac: i0.ɵɵFactoryDeclaration<DxiGanttStripLineModule, never>;
    static ɵmod: i0.ɵɵNgModuleDeclaration<DxiGanttStripLineModule, [typeof DxiGanttStripLineComponent], never, [typeof DxiGanttStripLineComponent]>;

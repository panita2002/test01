...
export declare class DxRadioGroupComponent extends DxComponent implements OnDestroy, ControlValueAccessor, OnChanges, DoCheck {
    ...
    set itemsChildren(value: QueryList<DxiRadioGroupItemComponent>);

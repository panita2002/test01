...
export declare class DxoFormLabelComponent extends NestedOption implements AfterViewInit, OnDestroy, OnInit, IDxTemplateHost {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<DxoFormLabelComponent, "dxo-form-label", never, { "alignment": { "alias": "alignment"; "required": false; }; "location": { "alias": "location"; "required": false; }; "showColon": { "alias": "showColon"; "required": false; }; "template": { "alias": "template"; "required": false; }; "text": { "alias": "text"; "required": false; }; "visible": { "alias": "visible"; "required": false; }; }, {}, never, ["*"], false, never>;
}
export declare class DxoFormLabelModule {
    static ɵfac: i0.ɵɵFactoryDeclaration<DxoFormLabelModule, never>;
    static ɵmod: i0.ɵɵNgModuleDeclaration<DxoFormLabelModule, [typeof DxoFormLabelComponent], never, [typeof DxoFormLabelComponent]>;

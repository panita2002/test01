...
export declare class DxiFormNumericRuleComponent extends CollectionNestedOption {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<DxiFormNumericRuleComponent, "dxi-form-numeric-rule", never, { "ignoreEmptyValue": { "alias": "ignoreEmptyValue"; "required": false; }; "message": { "alias": "message"; "required": false; }; "type": { "alias": "type"; "required": false; }; }, {}, never, never, false, never>;
}
export declare class DxiFormNumericRuleModule {
    static ɵfac: i0.ɵɵFactoryDeclaration<DxiFormNumericRuleModule, never>;
    static ɵmod: i0.ɵɵNgModuleDeclaration<DxiFormNumericRuleModule, [typeof DxiFormNumericRuleComponent], never, [typeof DxiFormNumericRuleComponent]>;

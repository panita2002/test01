...
export declare class DxFormComponent extends DxComponent implements OnDestroy, OnChanges, DoCheck {
    ...
    set buttonItemsChildren(value: QueryList<DxiFormButtonItemComponent>);
    get emptyItemsChildren(): QueryList<DxiFormEmptyItemComponent>;
    set emptyItemsChildren(value: QueryList<DxiFormEmptyItemComponent>);
    get groupItemsChildren(): QueryList<DxiFormGroupItemComponent>;
    set groupItemsChildren(value: QueryList<DxiFormGroupItemComponent>);
    ...
    set simpleItemsChildren(value: QueryList<DxiFormSimpleItemComponent>);
    get tabbedItemsChildren(): QueryList<DxiFormTabbedItemComponent>;
    set tabbedItemsChildren(value: QueryList<DxiFormTabbedItemComponent>);

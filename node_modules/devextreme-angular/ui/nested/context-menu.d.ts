...
export declare class DxoContextMenuComponent extends DxoFileManagerContextMenu implements OnDestroy, OnInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<DxoContextMenuComponent, "dxo-context-menu", never, { "commands": { "alias": "commands"; "required": false; }; "enabled": { "alias": "enabled"; "required": false; }; "items": { "alias": "items"; "required": false; }; }, {}, ["commandsChildren", "itemsChildren"], never, false, never>;
}

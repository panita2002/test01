...
export declare class DxoMasterDetailComponent extends NestedOption implements AfterViewInit, OnDestroy, OnInit, IDxTemplateHost {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<DxoMasterDetailComponent, "dxo-master-detail", never, { "autoExpandAll": { "alias": "autoExpandAll"; "required": false; }; "enabled": { "alias": "enabled"; "required": false; }; "template": { "alias": "template"; "required": false; }; }, {}, never, ["*"], false, never>;
}

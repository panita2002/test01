...
export declare class DxoBehaviorComponent extends NestedOption implements OnDestroy, OnInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<DxoBehaviorComponent, "dxo-behavior", never, { "allowSlidersSwap": { "alias": "allowSlidersSwap"; "required": false; }; "animationEnabled": { "alias": "animationEnabled"; "required": false; }; "callValueChanged": { "alias": "callValueChanged"; "required": false; }; "manualRangeSelectionEnabled": { "alias": "manualRangeSelectionEnabled"; "required": false; }; "moveSelectedRangeByClick": { "alias": "moveSelectedRangeByClick"; "required": false; }; "snapToTicks": { "alias": "snapToTicks"; "required": false; }; "valueChangeMode": { "alias": "valueChangeMode"; "required": false; }; }, {}, never, never, false, never>;
}

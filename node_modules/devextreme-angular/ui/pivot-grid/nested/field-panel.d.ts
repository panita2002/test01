...
export declare class DxoPivotGridFieldPanelComponent extends NestedOption implements OnDestroy, OnInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<DxoPivotGridFieldPanelComponent, "dxo-pivot-grid-field-panel", never, { "allowFieldDragging": { "alias": "allowFieldDragging"; "required": false; }; "showColumnFields": { "alias": "showColumnFields"; "required": false; }; "showDataFields": { "alias": "showDataFields"; "required": false; }; "showFilterFields": { "alias": "showFilterFields"; "required": false; }; "showRowFields": { "alias": "showRowFields"; "required": false; }; "texts": { "alias": "texts"; "required": false; }; "visible": { "alias": "visible"; "required": false; }; }, {}, never, never, false, never>;
}
export declare class DxoPivotGridFieldPanelModule {
    static ɵfac: i0.ɵɵFactoryDeclaration<DxoPivotGridFieldPanelModule, never>;
    static ɵmod: i0.ɵɵNgModuleDeclaration<DxoPivotGridFieldPanelModule, [typeof DxoPivotGridFieldPanelComponent], never, [typeof DxoPivotGridFieldPanelComponent]>;

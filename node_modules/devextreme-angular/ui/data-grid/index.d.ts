...
export declare class DxDataGridComponent<TRowData = any, TKey = any> extends DxComponent implements OnDestroy, OnChanges, DoCheck {
    ...
    set columnsChildren(value: QueryList<DxiDataGridColumnComponent>);
    get sortByGroupSummaryInfosChildren(): QueryList<DxiDataGridSortByGroupSummaryInfoComponent>;
    set sortByGroupSummaryInfosChildren(value: QueryList<DxiDataGridSortByGroupSummaryInfoComponent>);
    ...
    set sortByGroupSummaryInfoLegacyChildren(value: QueryList<DxiSortByGroupSummaryInfoComponent>);

...
export declare class DxoDataGridFilterBuilderComponent extends NestedOption implements OnDestroy, OnInit {
    ...
    set customOperationsChildren(value: QueryList<DxiDataGridCustomOperationComponent>);
    get fieldsChildren(): QueryList<DxiDataGridFieldComponent>;
    set fieldsChildren(value: QueryList<DxiDataGridFieldComponent>);
...
export declare class DxoDataGridFilterBuilderModule {
    ...
    static ɵmod: i0.ɵɵNgModuleDeclaration<DxoDataGridFilterBuilderModule, [typeof DxoDataGridFilterBuilderComponent], never, [typeof DxoDataGridFilterBuilderComponent]>;

...
export declare class DxoDataGridLabelComponent extends NestedOption implements AfterViewInit, OnDestroy, OnInit, IDxTemplateHost {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<DxoDataGridLabelComponent, "dxo-data-grid-label", never, { "alignment": { "alias": "alignment"; "required": false; }; "location": { "alias": "location"; "required": false; }; "showColon": { "alias": "showColon"; "required": false; }; "template": { "alias": "template"; "required": false; }; "text": { "alias": "text"; "required": false; }; "visible": { "alias": "visible"; "required": false; }; }, {}, never, ["*"], false, never>;
}
export declare class DxoDataGridLabelModule {
    static ɵfac: i0.ɵɵFactoryDeclaration<DxoDataGridLabelModule, never>;
    static ɵmod: i0.ɵɵNgModuleDeclaration<DxoDataGridLabelModule, [typeof DxoDataGridLabelComponent], never, [typeof DxoDataGridLabelComponent]>;

...
export declare class DxoDataGridOperationDescriptionsComponent extends NestedOption implements OnDestroy, OnInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<DxoDataGridOperationDescriptionsComponent, "dxo-data-grid-operation-descriptions", never, { "between": { "alias": "between"; "required": false; }; "contains": { "alias": "contains"; "required": false; }; "endsWith": { "alias": "endsWith"; "required": false; }; "equal": { "alias": "equal"; "required": false; }; "greaterThan": { "alias": "greaterThan"; "required": false; }; "greaterThanOrEqual": { "alias": "greaterThanOrEqual"; "required": false; }; "lessThan": { "alias": "lessThan"; "required": false; }; "lessThanOrEqual": { "alias": "lessThanOrEqual"; "required": false; }; "notContains": { "alias": "notContains"; "required": false; }; "notEqual": { "alias": "notEqual"; "required": false; }; "startsWith": { "alias": "startsWith"; "required": false; }; }, {}, never, never, false, never>;
}
export declare class DxoDataGridOperationDescriptionsModule {
    ...
    static ɵmod: i0.ɵɵNgModuleDeclaration<DxoDataGridOperationDescriptionsModule, [typeof DxoDataGridOperationDescriptionsComponent], never, [typeof DxoDataGridOperationDescriptionsComponent]>;

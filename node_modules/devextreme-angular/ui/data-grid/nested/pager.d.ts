...
export declare class DxoDataGridPagerComponent extends NestedOption implements OnDestroy, OnInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<DxoDataGridPagerComponent, "dxo-data-grid-pager", never, { "allowedPageSizes": { "alias": "allowedPageSizes"; "required": false; }; "displayMode": { "alias": "displayMode"; "required": false; }; "infoText": { "alias": "infoText"; "required": false; }; "label": { "alias": "label"; "required": false; }; "showInfo": { "alias": "showInfo"; "required": false; }; "showNavigationButtons": { "alias": "showNavigationButtons"; "required": false; }; "showPageSizeSelector": { "alias": "showPageSizeSelector"; "required": false; }; "visible": { "alias": "visible"; "required": false; }; }, {}, never, never, false, never>;
}
export declare class DxoDataGridPagerModule {
    static ɵfac: i0.ɵɵFactoryDeclaration<DxoDataGridPagerModule, never>;
    static ɵmod: i0.ɵɵNgModuleDeclaration<DxoDataGridPagerModule, [typeof DxoDataGridPagerComponent], never, [typeof DxoDataGridPagerComponent]>;

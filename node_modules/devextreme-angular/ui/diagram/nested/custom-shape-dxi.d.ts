...
export declare class DxiDiagramCustomShapeComponent extends CollectionNestedOption implements AfterViewInit, IDxTemplateHost {
    ...
    set connectionPointsChildren(value: QueryList<DxiDiagramConnectionPointComponent>);
...
export declare class DxiDiagramCustomShapeModule {
    ...
    static ɵmod: i0.ɵɵNgModuleDeclaration<DxiDiagramCustomShapeModule, [typeof DxiDiagramCustomShapeComponent], never, [typeof DxiDiagramCustomShapeComponent]>;

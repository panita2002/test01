...
export declare class DxButtonGroupComponent extends DxComponent implements OnDestroy, OnChanges, DoCheck {
    ...
    set itemsChildren(value: QueryList<DxiButtonGroupItemComponent>);

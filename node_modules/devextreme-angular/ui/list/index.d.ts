...
export declare class DxListComponent<TItem = any, TKey = any> extends DxComponent implements OnDestroy, OnChanges, DoCheck {
    ...
    set itemsChildren(value: QueryList<DxiListItemComponent>);
    get menuItemsChildren(): QueryList<DxiListMenuItemComponent>;
    set menuItemsChildren(value: QueryList<DxiListMenuItemComponent>);
    ...
    set menuItemsLegacyChildren(value: QueryList<DxiMenuItemComponent>);

...
export declare class DxiListItemComponent extends CollectionNestedOption implements AfterViewInit, IDxTemplateHost {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<DxiListItemComponent, "dxi-list-item", never, { "badge": { "alias": "badge"; "required": false; }; "disabled": { "alias": "disabled"; "required": false; }; "html": { "alias": "html"; "required": false; }; "icon": { "alias": "icon"; "required": false; }; "key": { "alias": "key"; "required": false; }; "showChevron": { "alias": "showChevron"; "required": false; }; "template": { "alias": "template"; "required": false; }; "text": { "alias": "text"; "required": false; }; "visible": { "alias": "visible"; "required": false; }; }, {}, never, ["*"], false, never>;
}
export declare class DxiListItemModule {
    static ɵfac: i0.ɵɵFactoryDeclaration<DxiListItemModule, never>;
    static ɵmod: i0.ɵɵNgModuleDeclaration<DxiListItemModule, [typeof DxiListItemComponent], never, [typeof DxiListItemComponent]>;

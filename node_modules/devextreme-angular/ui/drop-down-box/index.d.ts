...
export declare class DxDropDownBoxComponent extends DxComponent implements OnDestroy, ControlValueAccessor, OnChanges, DoCheck {
    ...
    set buttonsChildren(value: QueryList<DxiDropDownBoxButtonComponent>);

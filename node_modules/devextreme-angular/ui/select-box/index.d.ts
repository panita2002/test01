...
export declare class DxSelectBoxComponent extends DxComponent implements OnDestroy, ControlValueAccessor, OnChanges, DoCheck {
    ...
    set buttonsChildren(value: QueryList<DxiSelectBoxButtonComponent>);
    get itemsChildren(): QueryList<DxiSelectBoxItemComponent>;
    set itemsChildren(value: QueryList<DxiSelectBoxItemComponent>);

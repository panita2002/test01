...
export declare class DxHtmlEditorComponent extends DxComponent implements OnDestroy, ControlValueAccessor, OnChanges, DoCheck {
    ...
    set mentionsChildren(value: QueryList<DxiHtmlEditorMentionComponent>);
    get mentionsLegacyChildren(): QueryList<DxiMentionComponent>;
    set mentionsLegacyChildren(value: QueryList<DxiMentionComponent>);

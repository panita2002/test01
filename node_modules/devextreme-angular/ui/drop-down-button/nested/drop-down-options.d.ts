...
export declare class DxoDropDownButtonDropDownOptionsComponent extends NestedOption implements OnDestroy, OnInit {
    ...
    set toolbarItemsChildren(value: QueryList<DxiDropDownButtonToolbarItemComponent>);
...
export declare class DxoDropDownButtonDropDownOptionsModule {
    ...
    static ɵmod: i0.ɵɵNgModuleDeclaration<DxoDropDownButtonDropDownOptionsModule, [typeof DxoDropDownButtonDropDownOptionsComponent], never, [typeof DxoDropDownButtonDropDownOptionsComponent]>;

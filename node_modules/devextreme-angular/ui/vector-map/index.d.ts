...
export declare class DxVectorMapComponent extends DxComponent implements OnDestroy, OnChanges, DoCheck {
    ...
    set annotationsChildren(value: QueryList<DxiVectorMapAnnotationComponent>);
    get layersChildren(): QueryList<DxiVectorMapLayerComponent>;
    set layersChildren(value: QueryList<DxiVectorMapLayerComponent>);
    get legendsChildren(): QueryList<DxiVectorMapLegendComponent>;
    set legendsChildren(value: QueryList<DxiVectorMapLegendComponent>);
    ...
    set legendsLegacyChildren(value: QueryList<DxiLegendComponent>);

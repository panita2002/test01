...
describe('layout', () => {
    ...
    it('should add routing to layout', () => __awaiter(void 0, void 0, void 0, function* () {
        let newAppTree = yield schematicRunner.runSchematic('workspace', workspaceOptions);
        appOptions.routing = false;
        newAppTree = yield schematicRunner.runSchematic('application', appOptions, newAppTree);
        const runner = new testing_1.SchematicTestRunner('schematics', collectionPath);
        const tree = yield runner.runSchematic('add-layout', options, appTree);

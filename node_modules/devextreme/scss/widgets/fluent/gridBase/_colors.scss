...
* $type color
*/
$datagrid-cell-modified-border-color: $button-success-text-hover-bg !default;
$datagrid-cell-removed-border-color: $datagrid-border-color !default;
$datagrid-row-removed-bg: $datagrid-hover-bg !default;
...
@if $mode == "light" {
  @if $color == "blue"{
    $datagrid-row-focused-bg: lighten(desaturate(adjust-hue($base-accent, 3), 0.98), 50.00) !default;
    $datagrid-filter-row-background-color: darken($datagrid-base-background-color, 2%) !default;
  }

  @if $color == "saas" {
    $datagrid-row-focused-bg: lighten(adjust-hue($base-accent, -1), 26.47) !default;
  ...
  $datagrid-draggable-column-text-color: lighten($base-text-color, 60) !default;
}

@if $mode == "dark" {
  $datagrid-row-focused-bg: #0c3b5e !default;
  ...
  $datagrid-text-stub-background-image-path: url("data:image/png;base64,") !default;
  $datagrid-cell-removed-text-color: $datagrid-columnchooser-item-color !default;
  $datagrid-draggable-column-text-color: darken($base-text-color, 63.9) !default;
}

...
export const ListBase = CollectionWidget.inherit({
    ...
    _itemSelectHandler(e) {
        const isSingleSelectedItemClicked = "single" === this.option("selectionMode") && this.isItemSelected(e.currentTarget);
    ...
    _getElementClassToSkipRefreshId: () => "dx-list-group-header",

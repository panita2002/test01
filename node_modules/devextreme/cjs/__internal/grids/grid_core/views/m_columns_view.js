...
class ColumnsView extends((0, _m_column_state_mixin.ColumnStateMixin)(_m_modules.default.View)) {
    ...
    _setCellAriaAttributes($cell, cellOptions, options) {
        if ("freeSpace" !== cellOptions.rowType) {
            ...
            if (null !== options && void 0 !== options && null !== (_options$row = options.row) && void 0 !== _options$row && null !== (_options$row = _options$row.node) && void 0 !== _options$row && _options$row.hasChildren) {
                const {
                    row: row
                } = options;

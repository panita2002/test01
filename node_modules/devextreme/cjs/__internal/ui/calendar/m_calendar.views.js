...
const Views = {
    month: _m_calendar.default.inherit({
        ...
        getNavigatorCaption() {
            return _date.default.format(this.option("date"), "monthandyear")
        },
        ...
        _getCellText: cellDate => _date.default.format(cellDate, "d"),
        _getDayCaption(day) {
    ...
    year: _m_calendar.default.inherit({
        ...
        _getCellText: cellDate => _date.default.getMonthNames("abbreviated")[cellDate.getMonth()],
        _getFirstCellData() {
        ...
        getNavigatorCaption() {
            return _date.default.format(this.option("date"), "yyyy")
        },
        isBoundary(date) {
    ...
    decade: _m_calendar.default.inherit({
        ...
        _isDateOutOfRange(cellDate) {
            ...
            return !_date2.default.dateInRange(cellDate.getFullYear(), min && min.getFullYear(), max && max.getFullYear())
        },
        _isOtherView(cellDate) {
        ...
        _isStartDayOfMonth: () => false,
        _isEndDayOfMonth: () => false,
        _getCellText: cellDate => _date.default.format(cellDate, "yyyy"),
        _getFirstCellData() {
        ...
        _isValueOnCurrentView: (currentDate, value) => _date2.default.sameDecade(currentDate, value),
        _getCellByDate(date) {
            const foundDate = new Date(date);
            foundDate.setDate(1);

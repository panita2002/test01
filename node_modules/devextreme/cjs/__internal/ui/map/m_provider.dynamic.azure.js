...
let azureMapsLoader;
const AzureProvider = _m_provider.default.inherit({
    _mapType(type) {
        const mapTypes = {
            roadmap: "road",
            satellite: "satellite",
    ...
    _loadMapStyles: () => new Promise((resolve => {
        _ajax.default.sendRequest({
            url: AZURE_CSS_URL,
            dataType: "text"
        }).then((css => {
    ...
    _renderTooltip(location, options) {
        ...
        const $content = (0, _renderer.default)("<div>").text(options.text).addClass("dx-map-marker-tooltip");
